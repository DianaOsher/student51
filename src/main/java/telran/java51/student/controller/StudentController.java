...
public class StudentController {
	...
	public List<StudentDto> finStudentByName(@PathVariable String name) {
		return studentService.finStudentByName(name);
	}
	...
	public List<StudentDto> getStudentByExamMinScores(@PathVariable String exam,@PathVariable Integer minScore) {
		return studentService.getStudentByExamMinScores(exam, minScore);
	}
